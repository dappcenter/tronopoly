...
contract Tronopoly{
    ...
    uint256 public interest = 500;  // 5% , this number is divided by 10000
    uint256 public minutesElapse = 60*24; // production 60 * 24 
    uint256 public minimum = 1000000; // minimum deposit = 1 trx
   
    uint256 private referralDivRate = 5; // 10% to valid referrals
    uint256 private devDivRate = 15; // 15% to marketing and dev
